...
<table>
	<tr><th>Supplier First Name:</th><th><input type="text" name="firstname" ></th></tr>
	<tr><th>supplier Last Name:</th><th><input type="text" name="lastname" ></th></tr>
   <tr><th>Created-Date:</th><th><input type="text" name="createdDate" ></th></tr> 
   <tr><th>Supplier Contact Person:</th><th><input type="text" name="supplierName" ></th></tr>
   <tr><th>Supplier Contact Person Mobile:</th><th><input type="text" name="supplierNumber" ></th></tr>
